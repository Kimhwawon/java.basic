...
public class String11P399 {
	...
	public static void main(String[] args) {
		...
		System.out.println(c + 1); // 문자로 바꿔줘서 일이 그냥 뒤에 붙어버림 
		...
		System.out.println(d + 1); // 문자로 바꿔줘서 일이 그냥 뒤에 붙어버림 
		
		String e = String.valueOf(false);
		System.out.println(e);
		System.out.println(e + 1);  // 문자로 바꿔줘서 일이 그냥 뒤에 붙어버림 
