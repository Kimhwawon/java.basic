...
public class Date01 {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy - MM"); // 양식을 넣어줘야함. yyyy는 연도, MM은 월, dd는 일, hh는 시, mm은 분, ss는 초 ;
				String strNow2 = sdf.format(now); // 원래 만들어졌떤 Date를 .format()에 넣어줌
